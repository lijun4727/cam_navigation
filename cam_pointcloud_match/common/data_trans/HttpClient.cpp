	...
	connect(m_reply, &QNetworkReply::finished, this, [this]
		{
			...
			{
				m_downloadCallback(0, m_writenSize, m_totalSize, HttpErrorCode::Fail);
				return;
			}

			m_downloadCallback(0, m_writenSize, m_totalSize, HttpErrorCode::Success);
		}
	);
	...
	(qint64 bytesReceived, qint64 bytesTotal)
		{
			...
			m_writenSize = bytesReceived;
			m_downloadCallback(m_curReciveSize, m_writenSize, m_totalSize, HttpErrorCode::Downloading);
		}
	);
